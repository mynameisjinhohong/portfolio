...
public class HexGrid_Develope: MonoBehaviour
{
    ...
    public static HexGrid_Develope instance;
    ...
    public void SaveMap()
    {
        ...
        File.WriteAllText(Application.dataPath + "/map1.txt", strArr);
    }

    public void LoadMap()
    {
        int a = 0;
        string dataStr = File.ReadAllText((Application.dataPath + "/map1.txt"));
